...
This plugin handles creating and destroying the tests environment and
tests database and provides some useful text fixtures.
"""
...
def pytest_addoption(parser):
    ...
    group.addoption(
        ...
        "and do not remove it when the tests finishes.",
    )
    group.addoption(
        "--create-db",
        action="store_true",
    ...
    group.addoption(
        ...
        dest="nomigrations",
        default=False,
        help="Disable Django migrations on tests setup",
    )
    group.addoption(
        "--migrations",
        action="store_false",
        dest="nomigrations",
        default=False,
        help="Enable Django migrations on tests setup",
    )
    parser.addini(
...
def pytest_load_initial_conftests(early_config, parser, args):
    ...
    early_config.addinivalue_line(
        "markers",
        "django_db(transaction=False): Mark the tests as using "
        "the Django tests database.  The *transaction* argument marks will "
        "allow you to use real transactions in the tests like Django's "
        "TransactionTestCase.",
    )
    early_config.addinivalue_line(
        "markers",
        "urls(modstr): Use a different URLconf for this tests, similar to "
...
def django_test_environment(request):
    ...
    XXX It is a little dodgy that this is an autouse fixture.  Perhaps
        ...
        without duplicating a lot more of Django's tests support code
...
def _fail_for_invalid_template_variable():
    ...
    This fixture will fail each tests that uses django template rendering
